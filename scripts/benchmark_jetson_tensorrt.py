...
file_path = benchmark_dir / "jetson_orin_tensorrt.csv"
...
with open(file_path, "a", newline="") as file:
    ...
    writer.writerow([datetime.now().strftime("%Y-%m-%d %H:%M:%S"), "NVIDIA Jetson Orin Nano", "TensorRT FP16", "YOLOv8n-pose", "Random Forest", len(fps_values), round(avg_fps, 2), round(avg_pose, 2), round(avg_classifier, 2)])
